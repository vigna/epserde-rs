...
impl<T: SerializeInner + IsEpCopy + TypeName> SerializeInner for Vec2D<T> {
...
impl<T: DeserializeZeroCopyInner + IsEpCopy + 'static> DeserializeZeroCopyInner for Vec2D<T>
where
